...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('role', postgresql.ENUM('user', 'agent_developer', 'admin', name='userrole'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('pending', 'in_progress', 'completed', 'failed', 'cancelled', name='taskstatus'), nullable=False),
