...
def upgrade() -> None:
    ...
    op.execute("DROP TABLE IF EXISTS a2a_messages CASCADE")
    op.execute("DROP TABLE IF EXISTS a2a_conversations CASCADE")
    op.execute("DROP TABLE IF EXISTS agent_trust_scores CASCADE")
