...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('open', 'bidding', 'awarded', 'in_progress', 'delivered', 'validated', 'settled', 'cancelled', 'failed', name='contractstatus', create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('active', 'awaiting_response', 'resolved', 'failed', 'terminated', name='conversationstatus', create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('message_type', postgresql.ENUM('query', 'response', 'notification', 'proposal', 'acceptance', 'rejection', 'termination', name='messagetype', create_type=False), nullable=False),
