          ...
          <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-white/10 py-4">
            ...
            <div className="flex flex-1 items-center justify-end gap-8">
              <div className="hidden md:flex items-center gap-9">
                <a className="text-gray-300 hover:text-white text-sm font-medium leading-normal transition-colors" href="#">Agents</a>
              ...
              <a href="#" className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-primary text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-red-700 transition-colors">
                <span className="truncate">Log In</span>
              </a>
            </div>
          </header>
        </div>
        <main className="flex flex-1 items-center justify-center px-4 sm:px-6 md:px-10 lg:px-20 xl:px-40">
          <div className="layout-content-container flex max-w-[960px] flex-1 flex-col items-center">
            <div className="relative flex min-h-[480px] w-full flex-col items-center justify-center gap-8 p-4 text-center">
              ...
              <a href="#" className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-6 bg-primary text-white text-base font-bold leading-normal tracking-[0.015em] hover:bg-red-700 transition-colors shadow-lg shadow-primary/20">
                <span className="truncate">Explore Agents</span>
              </a>
            </div>
          </div>
        </main>
